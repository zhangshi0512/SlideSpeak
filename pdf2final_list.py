...
def process(topic_list):
    ...
    for topic in topic_list:
        ...
        if "Summary:" in text:
            ...
            dct["Topic"] = topic
            dct["Summary"] = ["Error: Summary not found in GPT response."]
        print(dct)
        code = gpt.gpt_summarise(
            "I am giving you a topic. return a short sample code snippet for the given topic. do not write anything else.", topic)
